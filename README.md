...
### The Linear Baseline (Logistic Regression)
* **Performance:** Acc 0.40 | Savings £54,900
...
### The Non-Linear Ensemble (Random Forest)
* **Performance:** Acc 0.47 | Savings £47,010
...
### The Ultimate Engine (Advanced XGBoost)
* **Performance:** Acc 0.43 | Savings £55,290
...
* `/notebooks/06_model_optimization.ipynb`
* `/notebooks/07_production_b2spoke_model.ipynb`
